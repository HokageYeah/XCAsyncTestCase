...
Pod::Spec.new do |s|
  ...
  s.author             = { "fengyang0329" => "email@address.com" }
  # Or just: s.author    = "fengyang0329"
  # s.authors            = { "fengyang0329" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/fengyang0329"
